...
from losses.unlabeledloss import UnlabeledLossCLS
...
class Controller(pl.LightningModule):
    ...
    def __init__(self, cfg):
        ...
        self.unlabeled_energy_loss = UnlabeledLossCLS(0.1) # ????
    ...
    def training_step(self, batch, batch_idx: int, optimizer_idx=0):
        ...
        if optimizer_idx == 0:
            ...
            loss += 0.2 * self.kldiv(self.module.last1,
            ...
            loss += 0.4 * self.kldiv(self.module.last2,
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        ds2 = gen_dataset(self.cfg.test_path2, self.cfg.transform)
